...
document.addEventListener('DOMContentLoaded', function() {
    /* Year */
    const yearElement = document.querySelector('.lib-block-40-1 .col-1 .text-6 p, .block-13-1 .col-1 .text-6 p, .lib-block-5164-2 .col-4 .text-6 p, .dww-40-1-0 .col-1 .text-6 p');
    if (yearElement) {
